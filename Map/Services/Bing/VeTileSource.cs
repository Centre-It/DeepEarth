...
using DeepEarth.Client.Services.Bing.VEImageryService;
...
namespace DeepEarth.Client.Services.Bing
{
    ...
    public class VeTileSource : TileSource 
    {
        ...
        public VeTileSource(string ApplicationID)
        {
            appID = ApplicationID;
        ...
        public VeTileSource(string ApplicationID, VeMapModes mode)
        {
            appID = ApplicationID;
            _MapMode = mode;
