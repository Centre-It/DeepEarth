...
namespace DeepEarth.Client.MapControl.Layers
{
    ...
    public interface ISpatialReference
    {
        ...
        /// For DeepEarth.Client.MapControl, the datum is usually WGS (World Geodetic System) 1984 and the unit of measurement is a degree
        /// </summary>
        double AngularUnitOfMeasurement { get; set; }

        /// <summary>
        /// The authority body that defines the unit of measurement i.e. European Petroleum Survey Group (EPSG).  For DeepEarth.Client.MapControl
        ...
        /// <summary>
        /// The authority body that defines the standards for the spatial reference parameters.  For DeepEarth.Client.MapControl,
