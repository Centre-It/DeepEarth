...
namespace DeepEarth.Client.MapControl.Layers
{
    ...
    /// You need to inherit from this class to creat your own custom TileSource provider for DeepEarth.Client.MapControl
    /// </para>
    /// <example>
    /// 
    ...
    public class TileSource : MultiScaleTileSource, ITileSource
    {
        ...
        public TileSource(Map map,  int imageWidth, int imageHeight, int tileWidth, int tileHeight,  int tileOverlap)
