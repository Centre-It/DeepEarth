...
namespace DeepEarth.Client.MapControl.Geometry
{
    /// <summary>
    /// <para>
    /// Inherets from the DeepEarth.Client.MapControl PathBase abstract class and represents a
    /// closed series of points and corresponding line segments that make up a
    /// complete shape
    /// </para>
    /// <example>
    /// 
    /// <code title="This is the DeepEarth.Client.MapControl example for the Bermuda Triangle">
    ...
    {
        protected internal Brush _Brush;
        protected internal static Brush _DefaultBrush = new SolidColorBrush(Color.FromArgb(128, 255, 255, 255));
        ...
        ///<param name="fillBrush">Can be any type of brush, SolidColor, Gradient, etc...</param>
        ///<param name="lineThickness"></param>
        public Polygon(Color lineColor, Brush fillBrush, double lineThickness)
        {
            LineColor = lineColor;
        ...
        public Brush Fill
        {
            get
            {
                if (_Brush == null) _Brush = _DefaultBrush;
                return _Brush;
            }
            set
            {
