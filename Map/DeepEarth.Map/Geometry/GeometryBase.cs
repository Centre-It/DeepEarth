...
namespace DeepEarth.Client.MapControl.Geometry
{
    ...
    /// <summary>
    /// <para>
    /// The abstract class upon which all DeepEarth.Client.MapControl geometry or 'shapes' are derived.
    /// All DeepEarth.Client.MapControl points (PointBase), paths (i.e. lines; PathBase),
