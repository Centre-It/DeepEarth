...
namespace DeepEarth.Client.MapControl
{
    ...
    [TemplatePart(Name = PART_DrawControl, Type = typeof(DrawControl))]
    ...
    public class Map : Control
    {
        ...
        private const string PART_DrawControl = "PART_DrawControl";
        ...
        public Map()
        {
            ...
            Events.MapLoaded += (o, e) => UpdateStartupPoint();
        ...
        /// <summary>
        /// Provides public accessor to the DrawControl.
        /// </summary>
        public DrawControl GeometryTools
        {
        ...
        /// <summary>
        /// The main raster tilelayer of the map. This is the DeepZoom Tileset that is the core of DeepEarth.Client.MapControl
        /// </summary>
        ...
        public Rect LogicalBounds
        {
            get
            {
                ...
                if(_TileLayer.MSI != null)
                {
                    var pixelExtent = new Point(PixelOrigin.X + _TileLayer.MSI.ActualWidth, PixelOrigin.Y + _TileLayer.MSI.ActualHeight);
        ...
        {
            if(BaseLayer.Source != null && _TileLayer.MSI != null && BaseLayer.Source.IsInitialized && Events.EnableMapZoom)
            {
        ...
        private bool _IsStartupPointSet = false;
        ...
        public override void OnApplyTemplate()
        {
            ...
            _DrawControl = (DrawControl)GetTemplateChild(PART_DrawControl);
            _DrawControl.MapInstance = this;
        ...
        private void UpdateClippingArea()
        {
            if(ActualHeight > 0 && ActualWidth > 0)
            {
                ...
                //    if (layer is Canvas)
                //    {
                //        Canvas canvasLayer = (Canvas)layer;
                //        canvasLayer.Clip = clip;
                //    }
                //}
