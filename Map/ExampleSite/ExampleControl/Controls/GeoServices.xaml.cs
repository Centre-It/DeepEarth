...
namespace ExampleControl.Controls
{
    public partial class GeoServices : ILayer
    {
        ...
        public GeoServices()
        {
            ...
            InitializeComponent();
            Loaded += GeoServices_Loaded;
        }

        void GeoServices_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (HtmlPage.IsEnabled)
            {
                ...
                MapInstance.Events.MapLoaded += (o, ev) => ConfigureDevPins();
            }
        }
        ...
        {
            ////Sample Polygons added to the map
            if (shapeLayer == null)
            {
                shapeLayer = new GeometryLayer(MapInstance) { ID = "POLYGONLAYER" };
                shapeLayer.UpdateMode = GeometryLayer.UpdateModes.PanOnlyUpdate; 
