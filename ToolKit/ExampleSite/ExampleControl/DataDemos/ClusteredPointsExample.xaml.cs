...
{
    public partial class ClusteredPointsExample
    {
        public ClusteredPointsExample()
        {
            InitializeComponent();
            Loaded += ClusteredPointsExamples_Loaded;
        }

        void ClusteredPointsExamples_Loaded(object sender, RoutedEventArgs e)
        {
