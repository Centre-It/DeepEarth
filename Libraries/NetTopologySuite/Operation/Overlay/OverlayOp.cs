...
namespace GisSharpBlog.NetTopologySuite.Operation.Overlay
{
    ...
    public class OverlayOp : GeometryGraphOperation
    {
        ...
        private IList resultPolyList   = new List<IPolygon>();
        private IList resultLineList   = new List<ILineString>();
        private IList resultPointList  = new List<IPoint>();
        ...
        private void ComputeOverlay(SpatialFunction opCode)
        {
            ...
            IList baseSplitEdges = new List<Edge>();
        ...
        {
            IList newEdges = new List<Edge>();
            IList edgesToRemove = new List<Edge>();
