...
namespace GisSharpBlog.NetTopologySuite.Operation.Polygonize
{
    ...
    public class Polygonizer
    {
        ...
        /// </summary>
        protected IList dangles = new List<ILineString>();

        /// <summary>
        /// 
        /// </summary>
        protected IList cutEdges = new List<ILineString>();

        /// <summary>
        /// 
        /// </summary>
        protected IList invalidRingLines = new List<ILineString>();
        ...
        private void Polygonize()
        {
            ...
            IList validEdgeRingList = new List<EdgeRing>();
            invalidRingLines = new List<ILineString>();
