...
//				return(true); 
	...
	public class StreamTokenizer
	{
		...
		/// <returns>bool - true for success</returns>
		public bool Tokenize(ICollection<Token> tokens)
		{
			Token token;
			this.lineNumber = 1;
		...
		/// <param name="tokens">The ArrayList to append to.</param>
		/// <returns>bool - true for success, false for failure.</returns>
		public bool TokenizeReader(TextReader tr, ICollection<Token> tokens)
		{
			textReader = tr;
		...
		/// <returns>bool - true for success, false for failure.</returns>
		public bool TokenizeFile(string fileName, ICollection<Token> tokens)
		{
		...
		/// <param name="tokens">The ArrayList to put tokens in.</param>
		/// <returns>bool - true for success, false for failure.</returns>
		public bool TokenizeString(string str, ICollection<Token> tokens)
		{
			textReader = new StringReader(str);
			return(Tokenize(tokens));
		}
		...
		/// <param name="tokens">The ArrayList to put tokens in.</param>
		/// <returns>bool - true for success, false for failure.</returns>
		public bool TokenizeStream(Stream s, ICollection<Token> tokens)
		{
