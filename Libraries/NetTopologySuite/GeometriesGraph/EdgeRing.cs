...
namespace GisSharpBlog.NetTopologySuite.GeometriesGraph
{
    ...
    public abstract class EdgeRing
    {
        ...
        private IList edges = new List<object>();  // the DirectedEdges making up this EdgeRing
        private IList pts = new List<ICoordinate>();
        ...
        private List<EdgeRing> holes = new List<EdgeRing>(); // a list of EdgeRings which are holes in this EdgeRing
