...
#else
			return GisSharpBlog.NetTopologySuite.Utilities.BitConverter.Int64BitsToDouble(bits);
#endif
        }
...
#else
			xBits = GisSharpBlog.NetTopologySuite.Utilities.BitConverter.DoubleToInt64Bits(x);
#endif
        }
...
#else
				return GisSharpBlog.NetTopologySuite.Utilities.BitConverter.DoubleToInt64Bits(xBits);
#endif
            }
        }
