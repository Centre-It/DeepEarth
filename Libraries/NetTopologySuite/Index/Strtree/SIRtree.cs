...
namespace GisSharpBlog.NetTopologySuite.Index.Strtree
{
    ...
    public class SIRtree : AbstractSTRtree 
    {
        ...
        /// 
        /// </summary>
        private class AnnonymousComparerImpl : IComparer<IBoundable>
        {    
            /// <summary>
            /// 
            /// </summary>
            ...
            {
                return new SIRtree().CompareDoubles(((Interval)o1.Bounds).Centre, 
                                                    ((Interval)o2.Bounds).Centre);
            }
        }        
        ...
        private IComparer<IBoundable> comparator = new AnnonymousComparerImpl(); 
