...
namespace GisSharpBlog.NetTopologySuite.Index.Strtree
{
    ...
    public abstract class AbstractSTRtree
    {
        ...
        private List<ItemBoundable> itemBoundables = new List<ItemBoundable>();
        ...
        protected virtual IList CreateParentBoundables(IList childBoundables, int newLevel)
        {
            ...
            var parentBoundables = new List<IBoundable>();
        ...
        /// </summary>
        /// <returns></returns>
        protected abstract IComparer<IBoundable> GetComparer();
    }
}
