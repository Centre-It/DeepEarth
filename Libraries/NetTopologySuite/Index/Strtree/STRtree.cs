...
namespace GisSharpBlog.NetTopologySuite.Index.Strtree
{
    ...
    public class STRtree : AbstractSTRtree, ISpatialIndex 
    {
        ...
        /// 
        /// </summary>        
        private class AnonymousXComparerImpl : IComparer<IBoundable>
        {
            ...
            /// <param name="o2"></param>
            /// <returns></returns>
			public int Compare(IBoundable o1, IBoundable o2) 
            {
                return container.CompareDoubles(container.CentreX((IEnvelope)o1.Bounds),
                                                container.CentreX((IEnvelope)o2.Bounds));
            }
        }
        ...
        /// 
        /// </summary>
        private class AnonymousYComparerImpl : IComparer<IBoundable>
        {
            private STRtree container = null;
			...
			public int Compare(IBoundable o1, IBoundable o2) 
            {
                return container.CompareDoubles(container.CentreY((IEnvelope)o1.Bounds),
                                                container.CentreY((IEnvelope)o2.Bounds));
            }
        }
        ...
        protected override IList CreateParentBoundables(IList childBoundables, int newLevel)
        {
            ...
            var sortedChildBoundables = new List<IBoundable>(childBoundables as IEnumerable<IBoundable>);
        ...
        /// </summary>
        /// <returns></returns>
        protected override IComparer<IBoundable> GetComparer() 
        {
