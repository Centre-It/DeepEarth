...
namespace GisSharpBlog.NetTopologySuite.IO.GML2
{
    ...
    public class GMLWriter
    {
        ...
        protected void Write(ICoordinate coordinate, XmlWriter writer)
        {
        ...
        /// <param name="writer"></param>        
		protected void Write(ICoordinate[] coordinates, XmlWriter writer)
        {
        ...
        /// <param name="geometry"></param>
        /// <param name="writer"></param>
		protected void Write(IGeometry geometry, XmlWriter writer)
        {
